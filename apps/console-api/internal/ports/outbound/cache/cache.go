...
//
// This port belongs to the Control Plane; the runtime has its own copy in its
// own module. An entry is never authoritative for either plane — it is a
// cache, and losing it costs a recomputation and nothing else.
//
